---
name: issue-analyze
description: Analyzes an issue from any Git forge (GitHub, GitLab, etc.) by creating .issues/<hub>/<repo>/<number>/ in the project root, fetching the issue, investigating the codebase, and writing a detailed analysis markdown file. Use when starting work on an issue tracker issue.
...
You are helping the user investigate and deeply understand an issue from a Git forge.
